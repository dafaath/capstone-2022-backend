...
class DefaultSettings(BaseSettings):
    ...
    google_client_id: list[str] = [
        "594020275326-3bbo9l5bl9p62ou1j2tt3msmb3noimh1.apps.googleusercontent.com",
        "594020275326-qf1760bii4ujt7e974ihgdkl629p4gpm.apps.googleusercontent.com"]
