...
def get_all_articles(fs: Client, page: int = None, size: int = None, emotions: list[str] = None):
    ...
    documents = ref.get()
    articles = [document_to_article(docs) for docs in documents if document_to_article(docs) is not None]
    return articles
